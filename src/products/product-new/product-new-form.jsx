...
import Buttons from './product-new-buttons.jsx'
				...
				<form onSubmit={props.handleSubmit}>
					...
					<div className="bar-flex">
						...
						<div>
							...
							<ErrorMessage name="category_id" component="div" className="error-message-form" onBlur={e => {props.setStatus({successMessage: null}) }} />
						</div>
					</div>
