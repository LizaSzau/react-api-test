...
--
-- Gép: 127.0.0.1:3308
-- Létrehozás ideje: 2020. Sze 09. 12:03
...
--
-- Tábla szerkezet ehhez a táblához `api_categories`
--
...
--
-- A tábla adatainak kiíratása `api_categories`
--

INSERT INTO `api_categories` (`id`, `name`, `description`, `created`, `modified`) VALUES
...
--
-- Tábla szerkezet ehhez a táblához `api_products`
--
...
--
-- A tábla adatainak kiíratása `api_products`
--

INSERT INTO `api_products` (`id`, `name`, `description`, `price`, `category_id`, `created`, `modified`) VALUES
...
(65, 'xxx', 'xxx', '0', 5, '2020-09-09 08:47:44', '2020-09-09 08:47:44'),
(66, 'xxx', 'xxx', '0', 5, '2020-09-09 08:48:19', '2020-09-09 08:48:19');
COMMIT;
